...
def create_palette(
    ...
    Colors are generated by alg.generate:

    * Dark colors are based on parameters dark_*
    * Bright colors are based on parameters bright_*
    ...
    colors = [
        oklch_to_hex(*c)
        for c in generate(dark_L, dark_sky_shift, dark_ocean_shift)
